...
b0 = Nb*0.02 + 0.5;
b1=(0.9822+0.0178*Nb)*b0*(-1)^(Nb+1);
b2 = b0*(0.8+0.2*(mod(Nb,5)));
b = [b0,b1,b2];
a0=1;
a1 = (0.778+0.025*Nb)*(-1)^Nb;
a2 = 0.64+0.006*Nb;

a = [a0,a1,a2];     % бейрнп йнщттхжхемрнб гмюлемюрекъ оепедюрнвмни тсмйжхх
N1 = mod(Nb,10)+20;   % дкхмю хлоскэямни уюпюйрепхярхйх
N2 = mod(Nb,10)+30;   % дкхмю бнгдеиярбхъ
Fs = 1000*Nb;   % вюярнрю дхяйперхгюжхх
